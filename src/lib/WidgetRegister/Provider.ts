...
export default class Provider {
  ...
  public get(params: string | IArguments): object | undefined {
    ...
    return Widgets.get(Provider.getArgs(this.arguments, local));
  }
  ...
  public render(
    ...
    const local: IArguments = Arguments.parseArgs(params);
    return Widgets.render(Provider.getArgs(this.arguments, local), props);
  }
