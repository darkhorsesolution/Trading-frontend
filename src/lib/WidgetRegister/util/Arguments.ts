...
export class Arguments implements IArguments {
	...
	public static parseArgs(params: any, thow: boolean = true): Arguments | never {
		
		if (thow && !Arguments.isValid(params)) {
			logger.error("arguments.common"); // id is essential, throw error instead of logging it
		}
	...
	public static parseComponentArgs(component: any, params: string | object): IArguments {
		...
		if(typeof component !== 'undefined') {
			...
			// WidgetRegister provided by component
