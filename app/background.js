...
/***/ "./electron/helpers/create-window.ts":
/*!*******************************************!*\
  !*** ./electron/helpers/create-window.ts ***!
  \*******************************************/
...
/* harmony export */ });
/* harmony import */ var _create_window__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create-window */ "./electron/helpers/create-window.ts");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers */ "./electron/helpers/index.ts");
...
(async () => {
  ...
  electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on("maximize", (_event, arg) => {
  ...
  electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on("minimize", (_event, arg) => {
    mainWindow.minimize();
  });
  electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on("close", (_event, arg) => {
    mainWindow.close();
  });
})();
